...
#define LCD_RS         	GPIO_Pin_3	//PC3--->>TFT --RS/DC
#define LCD_RST     		GPIO_Pin_0	//PC0--->>TFT --RST

#define LCD_CTRL   	  	GPIOB		//定义TFT数据端口
#define LCD_SCL        	GPIO_Pin_3	//PB3--->>TFT --SCL/SCK
#define LCD_SDA        	GPIO_Pin_5	//PB5 MOSI--->>TFT --SDA/DIN
#define LCD_CS        	GPIO_Pin_9 //MCU_PB9--->>TFT --CS/CE
