...
#define LCD_LED        	GPIO_Pin_4  //PC4 连接至TFT -LED
#define LCD_RS         	GPIO_Pin_3	//PC3连接至TFT --RS
#define LCD_CS        	GPIO_Pin_9  //PB9 连接至TFT --CS
#define LCD_RST     	  GPIO_Pin_0	//PC0连接至TFT --RST
#define LCD_SCL        	GPIO_Pin_3	//PB3连接至TFT -- CLK
#define LCD_SDA        	GPIO_Pin_5	//PB5连接至TFT - SDI
//VCC:可以接5V也可以接3.3V
...
void SPI1_Init(void)	
{
	...
	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable,ENABLE);/*开启SWD?关闭JTAG*/
